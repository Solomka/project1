...
public class VitaminSalad extends Salad {
	...
	protected Set<SortableSaladIngredient<Vegetable>> prepareSaladVegetables() {
		...
		vitaminSaladIngredients.add(
				new SortableSaladIngredient<Vegetable>(new Carrot("Flaccus carrot", 65.2, new BigDecimal(20)), 100));
		vitaminSaladIngredients.add(
				new SortableSaladIngredient<Vegetable>(new Cucumber("Ordinar cucumber", 15.5, new BigDecimal(17)), 70));
		vitaminSaladIngredients.add(
				new SortableSaladIngredient<Vegetable>(new Lettuce("Iceberg lettuce", 14.8, new BigDecimal(20)), 100));
		vitaminSaladIngredients
				.add(new SortableSaladIngredient<Vegetable>(new Onion("Leek onion", 60.9, new BigDecimal(15)), 20));
	...
	Set<SaladIngredient<Dressing>> prepareSaladDressings() {
		...
		vitaminSaladDressings.add(new SaladIngredient<Dressing>(new Oil("Olive oil", 884, new BigDecimal(230)), 30));
		vitaminSaladDressings
				.add(new SaladIngredient<Dressing>(new Oil("Sunflower oil", 884.1, new BigDecimal(100)), 20));
